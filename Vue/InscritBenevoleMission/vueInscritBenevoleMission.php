...
<form action="index.php?action=ajoutBenevoleMission" method="post">
<?php foreach($benevoles as $benevole):?>
<h2 style="text-align: center;">S'inscrire pour être bénévole sur <?= $benevole['titre'] ?></h2>

<br>

<div class="row justify-content-center align-items-center">
  <div class="col-md-5 form-group d-flex align-items-center">
  <label for="civilite" class="col-form-label label" style="width: 40%;" class="label">Civilité : <sup class="required">*</sup> </label>
...
<label class="form-check-label" for="inlineRadio2">Monsieur</label>
  ...
  <label for="nom" class="col-form-label label" style="width: 55%;">Nom : <sup class="required">*</sup></label>
    <input type="text"  style="text-align: center; width: 100%;" class="form-control" name="nom"  required>
  </div>

  <div class="col-md-4 form-group d-flex align-items-center">
  <label for="prenom" class="col-form-label label" style="width: 130%;">Prénom : <sup class="required">*</sup></label>
  <input type="text"  style="text-align: center; width: 150%;" class="form-control" name="prenom" required>
  </div>
  <!-- <div class="col-md-4 form-group d-flex align-items-center">
...
<div class="row justify-content-center align-items-center">
  <div class="col-md-4 form-group d-flex align-items-center">
  <label for="codePostal" class="col-form-label label" style="width: 45%;">Code Postal :  <sup class="required">*</sup></label>
...
<br>
    ...
    <label for="description" class="col-form-label me-3 label" style="width: 25%;">Commentaire : </label>
    <textarea name="commentaire" class="form-control" style="text-align: center;" rows="10" cols="50">Entrez votre texte ici</textarea>
    </div>

<!-- <label style="display: flex; align-items: center; justify-content: center;" class="label" for="commentaire">Commentaire:</label>

<div class="textareacontenir">
    <textarea name="commentaire" class="form-control" style="text-align: center;" rows="10" cols="50">Entrez votre texte ici</textarea>
    </div> -->
<br>
<input type="hidden"  class="form-control" style="text-align: center;" name="idMission"  value="<?= $benevole['idMission'] ?>" readonly="readonly" required>
