...
<h2 style="text-align: center;">S'inscrire pour etre un(e) benevole</h2>
<br>
<br>
...
<div class="form-check form-check-inline">
    ...
    <input type="text"  class="form-control" style="text-align: center;" name="id" placeholder="id" required>
    <br>
    <input type="text"  class="form-control" style="text-align: center;" name="nom" placeholder="nom" required>
    <br>
    ...
    <br>
    <input type="text"  class="form-control" style="text-align: center;" name="ville" placeholder="ville" required>
    <br>
...
<br>
<input type="text"  class="form-control" style="text-align: center;" name="commentaire" placeholder="commentaire" required>
    
<br>
<input type="text"  class="form-control" style="text-align: center;" name="idMission" placeholder="idMission" required>
<br>
