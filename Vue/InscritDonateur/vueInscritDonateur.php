...
<h2  style="text-align: center;">S'inscrire pour etre un(e) donateur(trice)</h2>
<br>
<br>
...
<div class="form-check form-check-inline">
    ...
    <br>
    <input type="text" class="form-control" style="text-align: center;" name="montant" placeholder="montant" required>
    <br>
